...
export const lightTheme = {
    ...
    pallet: {
      ...
      greyColor7: '#E4E4E4;', //      ${({theme}) => theme.pallet.greyColor7};
      greyColor8: '#EEEEEE;', //      ${({theme}) => theme.pallet.greyColor8};
      blueColor: '#0D6EFD', //      ${({theme}) => theme.pallet.blueColor};
      blueColor2: '#4267B2', //      ${({theme}) => theme.pallet.blueColor2};
      blueColor3: '#127FFF', //      ${({theme}) => theme.pallet.blueColor3};
